...
VALUES
    ...
    (28, 230.00, 30, 100, 10, 1),
    (29, 223.00, 20, 200, 10, 2),
    (30, 210.00, 10, 300, 10, 3),
    -- Item 11 original price 180.00 
    (31, 150.00, 30, 100, 11, 1),
    (32, 160.00, 20, 200, 11, 2),
    (33, 170.00, 10, 300, 11, 3),
    -- Item 12 original price 180.00 
    (34, 150.00, 30, 100, 12, 1),
    (35, 160.00, 20, 200, 12, 2),
    (36, 170.00, 10, 300, 12, 3),
    -- Item 13 original price 180.00 
    (37, 150.00, 30, 100, 13, 1),
    (38, 160.00, 20, 200, 13, 2),
    (39, 170.00, 10, 300, 13, 3),
ON CONFLICT (id) DO
UPDATE
SET
